...
InitSDKCalls()
{
    new Handle:conf = LoadGameConfigFile("adminmod.cfg");
    ...
    if (hGiveNamedItem == INVALID_HANDLE) {
        PrintToServer("[PVKII AdminMod] WARNING: Could not find SDK method: GiveNamedItem");
    }
    ...
    if (hWeapon_Equip == INVALID_HANDLE) {
        PrintToServer("[PVKII AdminMod] WARNING: Could not find SDK method: Weapon_Equip");
    }
    ...
    if (hGiveAmmo == INVALID_HANDLE) {
        PrintToServer("[PVKII AdminMod] WARNING: Could not find SDK method: GiveAmmo");
    }
    ...
    if (hRemoveAllItems == INVALID_HANDLE) {
        PrintToServer("[PVKII AdminMod] WARNING: Could not find SDK method: RemoveAllItems");
    }
